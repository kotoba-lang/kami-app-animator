 ...
 */
kami.sprite_gpu.prim__GT_quad = (function kami$sprite_gpu$prim__GT_quad(p__21858,p__21859){
var vec__21860 = p__21858;
var ex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21860,(0),null);
var ey = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21860,(1),null);
var vec__21863 = p__21859;
var kind = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21863,(0),null);
var map__21866 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21863,(1),null);
var map__21866__$1 = cljs.core.__destructure_map(map__21866);
var props = map__21866__$1;
var rot = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"rot","rot",757545242));
var ry = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"ry","ry",-334598563));
var rx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"rx","rx",1627208482));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var dx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"dx","dx",-381796732));
var fill = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"fill","fill",883462889));
var w = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"w","w",354169001));
var dy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"dy","dy",1719547243));
var h = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21866__$1,new cljs.core.Keyword(null,"h","h",1109658740));
var vec__21880 = (function (){var G__21883 = kind;
...
var sw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21880,(0),null);
var sh = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21880,(1),null);
var G__21899 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"pos","pos",-864607220),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(ex + (function (){var or__5002__auto__ = dx;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21899,new cljs.core.Keyword(null,"anim","anim",-1276068045),new cljs.core.Keyword(null,"anim","anim",-1276068045).cljs$core$IFn$_invoke$arity$1(props));
} else {
return G__21899;
}
});
kami.sprite_gpu.wave = (function kami$sprite_gpu$wave(t,ph,p__21904){
var vec__21905 = p__21904;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21905,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21905,(1),null);
...
var vec__21910 = new cljs.core.Keyword(null,"pos","pos",-864607220).cljs$core$IFn$_invoke$arity$1(quad);
var px = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21910,(0),null);
var py = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21910,(1),null);
var vec__21913 = new cljs.core.Keyword(null,"size","size",1098693007).cljs$core$IFn$_invoke$arity$1(quad);
var sw = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21913,(0),null);
var sh = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21913,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__21924){
var map__21925 = p__21924;
var map__21925__$1 = cljs.core.__destructure_map(map__21925);
var sprite = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21925__$1,new cljs.core.Keyword(null,"sprite","sprite",172516848));
var sx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21925__$1,new cljs.core.Keyword(null,"sx","sx",-403071592));
var sy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21925__$1,new cljs.core.Keyword(null,"sy","sy",227523849));
var ph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21925__$1,new cljs.core.Keyword(null,"ph","ph",-1483583977));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__21926){
var map__21927 = p__21926;
var map__21927__$1 = cljs.core.__destructure_map(map__21927);
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21927__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21927__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var rot = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21927__$1,new cljs.core.Keyword(null,"rot","rot",757545242));
var shape = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21927__$1,new cljs.core.Keyword(null,"shape","shape",1190694006));
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21927__$1,new cljs.core.Keyword(null,"color","color",1011675173));
