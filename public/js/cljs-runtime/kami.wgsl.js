...
var vec__21792 = t;
var head = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21792,(0),null);
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21792,(1),null);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(base),"<",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__21796 = (function (){var or__5002__auto__ = elem;
...
return (kami.wgsl.type_str.cljs$core$IFn$_invoke$arity$1 ? kami.wgsl.type_str.cljs$core$IFn$_invoke$arity$1(G__21796) : kami.wgsl.type_str.call(null, G__21796));
})()),">"].join('');
} else {
...
break;
case ".":
return ["(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__21799 = cljs.core.first(xs);
return (go.cljs$core$IFn$_invoke$arity$1 ? go.cljs$core$IFn$_invoke$arity$1(G__21799) : go.call(null, G__21799));
...
var G__21801 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"ident","ident",-742346),kami.wgsl.ident,new cljs.core.Keyword(null,"num","num",1985240673),kami.wgsl.num,new cljs.core.Keyword(null,"call","call",-519999866),kami.wgsl.wgsl_call,new cljs.core.Keyword(null,"special","special",-1125941630),kami.wgsl.wgsl_special], null);
var G__21802 = e;
return (kotoba.expr.compile.cljs$core$IFn$_invoke$arity$2 ? kotoba.expr.compile.cljs$core$IFn$_invoke$arity$2(G__21801,G__21802) : kotoba.expr.compile.call(null, G__21801,G__21802));
});
kami.wgsl.block = (function kami$wgsl$block(stmts){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21803_SHARP_){
return ["  ",clojure.string.replace((kami.wgsl.stmt.cljs$core$IFn$_invoke$arity$1 ? kami.wgsl.stmt.cljs$core$IFn$_invoke$arity$1(p1__21803_SHARP_) : kami.wgsl.stmt.call(null, p1__21803_SHARP_)),"\n","\n  ")].join('');
}),stmts));
});
kami.wgsl.for_step = (function kami$wgsl$for_step(s){
var vec__21804 = s;
var op = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21804,(0),null);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21804,(1),null);
var G__21807 = op;
...
var init = first__21814;
var first__21814__$1 = cljs.core.first(seq__21813__$1);
var seq__21813__$2 = cljs.core.next(seq__21813__$1);
var cnd = first__21814__$1;
var first__21814__$2 = cljs.core.first(seq__21813__$2);
var seq__21813__$3 = cljs.core.next(seq__21813__$2);
var step = first__21814__$2;
var body = seq__21813__$3;
...
kami.wgsl.param_str = (function kami$wgsl$param_str(p__21815){
var vec__21816 = p__21815;
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21816,(0),null);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21816,(1),null);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21816,(2),null);
...
(kami.wgsl.func.cljs$core$IFn$_invoke$arity$variadic = (function (name,p__21822,body){
var map__21823 = p__21822;
var map__21823__$1 = cljs.core.__destructure_map(map__21823);
var stage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21823__$1,new cljs.core.Keyword(null,"stage","stage",1843544772));
var workgroup_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21823__$1,new cljs.core.Keyword(null,"workgroup-size","workgroup-size",-1458663590));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21823__$1,new cljs.core.Keyword(null,"params","params",710516235));
var ret = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21823__$1,new cljs.core.Keyword(null,"ret","ret",-468222814));
...
/** @this {Function} */
(kami.wgsl.func.cljs$lang$applyTo = (function (seq21819){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21820,G__21821,seq21819__$2);
}));
 ...
 */
kami.wgsl.binding_STAR_ = (function kami$wgsl$binding_STAR_(p__21829,name,type){
var map__21830 = p__21829;
var map__21830__$1 = cljs.core.__destructure_map(map__21830);
var group = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21830__$1,new cljs.core.Keyword(null,"group","group",582596132));
var binding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21830__$1,new cljs.core.Keyword(null,"binding","binding",539932593));
var space = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21830__$1,new cljs.core.Keyword(null,"space","space",348133475));
var access = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21830__$1,new cljs.core.Keyword(null,"access","access",2027349272));
...
while(true){
if((i__5727__auto___21918 < len__5726__auto___21916)){
args__5732__auto__.push((arguments[i__5727__auto___21918]));

var G__21920 = (i__5727__auto___21918 + (1));
i__5727__auto___21918 = G__21920;
continue;
} else {
}
break;
...
/** @this {Function} */
(kami.wgsl.shader.cljs$lang$applyTo = (function (seq21836){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21836));
}));
