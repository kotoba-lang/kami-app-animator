...
var n__5593__auto___22303 = (4);
var c_22304 = (0);
while(true){
if((c_22304 < n__5593__auto___22303)){
var n__5593__auto___22306__$1 = (4);
var r_22307 = (0);
while(true){
if((r_22307 < n__5593__auto___22306__$1)){
(o[((c_22304 * (4)) + r_22307)] = (((((a[r_22307]) * (b[((c_22304 * (4)) + (0))])) + ((a[(r_22307 + (4))]) * (b[((c_22304 * (4)) + (1))]))) + ((a[(r_22307 + (8))]) * (b[((c_22304 * (4)) + (2))]))) + ((a[(r_22307 + (12))]) * (b[((c_22304 * (4)) + (3))]))));

var G__22324 = (r_22307 + (1));
r_22307 = G__22324;
continue;
} else {
}
...
kami.webgpu.mesh.translation_matrix = (function kami$webgpu$mesh$translation_matrix(p__22190){
var vec__22191 = p__22190;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22191,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22191,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22191,(2),null);
var o = kami.webgpu.mesh.m4();
(o[(0)] = (1));
...
kami.webgpu.mesh.scale_matrix = (function kami$webgpu$mesh$scale_matrix(p__22195){
var vec__22196 = p__22195;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22196,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22196,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22196,(2),null);
var o = kami.webgpu.mesh.m4();
(o[(0)] = x);
 ...
 */
kami.webgpu.mesh.model_matrix = (function kami$webgpu$mesh$model_matrix(p__22200){
var map__22202 = p__22200;
var map__22202__$1 = cljs.core.__destructure_map(map__22202);
var translation = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22202__$1,new cljs.core.Keyword(null,"translation","translation",-701621547),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null));
var rotation = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22202__$1,new cljs.core.Keyword(null,"rotation","rotation",-1728051644),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0)], null));
var scale = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22202__$1,new cljs.core.Keyword(null,"scale","scale",-230427353),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),(1),(1)], null));
var vec__22203 = rotation;
var rx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(0),null);
var ry = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(1),null);
var rz = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22203,(2),null);
 ...
 */
kami.webgpu.mesh.upload_texture_BANG_ = (function kami$webgpu$mesh$upload_texture_BANG_(p__22214,p__22215){
var map__22217 = p__22214;
var map__22217__$1 = cljs.core.__destructure_map(map__22217);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22217__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var map__22218 = p__22215;
var map__22218__$1 = cljs.core.__destructure_map(map__22218);
var bytes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22218__$1,new cljs.core.Keyword(null,"bytes","bytes",1175866680));
var mime_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22218__$1,new cljs.core.Keyword(null,"mime-type","mime-type",1058646439));
 ...
 */
kami.webgpu.mesh.upload_mesh_BANG_ = (function kami$webgpu$mesh$upload_mesh_BANG_(p__22221,p__22222){
var map__22223 = p__22221;
var map__22223__$1 = cljs.core.__destructure_map(map__22223);
var context = map__22223__$1;
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22223__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var map__22224 = p__22222;
var map__22224__$1 = cljs.core.__destructure_map(map__22224);
var geometry = map__22224__$1;
var positions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"positions","positions",-1380538434));
var normals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"normals","normals",-1508109067));
var indices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"indices","indices",-1218138343));
var uvs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"uvs","uvs",1776835110));
var morph_target_deltas = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"morph-target-deltas","morph-target-deltas",-1534652085));
var joints = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"joints","joints",-1993525003));
var weights = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22224__$1,new cljs.core.Keyword(null,"weights","weights",-1097626197));
...
var n__5593__auto___22611 = vcount;
var i_22612 = (0);
while(true){
if((i_22612 < n__5593__auto___22611)){
var base_22613 = (i_22612 * (16));
var p_22614 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(positions,i_22612);
var n_22615 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(normals,i_22612);
var uv_22616 = ((has_uv_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(uvs,i_22612):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.0,0.0], null));
var j_22617 = ((has_skin_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(joints,i_22612):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0),(0),(0)], null));
var w_22618 = ((has_skin_QMARK_)?cljs.core.nth.cljs$core$IFn$_invoke$arity$2(weights,i_22612):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [1.0,0.0,0.0,0.0], null));
interleaved.set(kami.webgpu.mesh.f32(p_22614),base_22613);

interleaved.set(kami.webgpu.mesh.f32(n_22615),(base_22613 + (3)));

interleaved.set(kami.webgpu.mesh.f32(uv_22616),(base_22613 + (6)));

joints_view.set((new Uint32Array(cljs.core.clj__GT_js(cljs.core.vec(j_22617)))),(base_22613 + (8)));

interleaved.set(kami.webgpu.mesh.f32(w_22618),(base_22613 + (12)));

var G__22620 = (i_22612 + (1));
i_22612 = G__22620;
continue;
} else {
}
...
(kami.webgpu.mesh.draw_BANG_.cljs$core$IFn$_invoke$arity$8 = (function (p__22239,pass,p__22240,mvp,color,morph_weights,joint_matrices,p__22241){
var map__22242 = p__22239;
var map__22242__$1 = cljs.core.__destructure_map(map__22242);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22242__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var pipe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22242__$1,new cljs.core.Keyword(null,"pipe","pipe",336575849));
var default_texture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22242__$1,new cljs.core.Keyword(null,"default-texture","default-texture",1829125666));
var default_sampler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22242__$1,new cljs.core.Keyword(null,"default-sampler","default-sampler",1041755191));
var map__22243 = p__22240;
var map__22243__$1 = cljs.core.__destructure_map(map__22243);
var idx_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"idx-count","idx-count",-1289353607));
var vbuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"vbuf","vbuf",303950747));
var morph_deltas_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"morph-deltas-buf","morph-deltas-buf",-129639776));
var ibuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"ibuf","ibuf",801056512));
var joint_matrices_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"joint-matrices-buf","joint-matrices-buf",-625207643));
var vertex_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"vertex-count","vertex-count",1997450535));
var morph_weights_buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"morph-weights-buf","morph-weights-buf",-451235347));
var gbuf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"gbuf","gbuf",897732527));
var morph_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"morph-count","morph-count",-176849136));
var joint_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22243__$1,new cljs.core.Keyword(null,"joint-count","joint-count",663399985));
var map__22244 = p__22241;
var map__22244__$1 = cljs.core.__destructure_map(map__22244);
var color_b = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22244__$1,new cljs.core.Keyword(null,"color-b","color-b",-988878341),color);
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22244__$1,new cljs.core.Keyword(null,"kind","kind",-717265803),(0));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22244__$1,new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.0,0.0,0.0,0.0], null));
var texture = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22244__$1,new cljs.core.Keyword(null,"texture","texture",-266291651));
var sampler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22244__$1,new cljs.core.Keyword(null,"sampler","sampler",2068889864));
var shade_kind = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22244__$1,new cljs.core.Keyword(null,"shade-kind","shade-kind",-1825128023),(0));
var toon_threshold = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22244__$1,new cljs.core.Keyword(null,"toon-threshold","toon-threshold",-2084408130),0.4);
var toon_smooth = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__22244__$1,new cljs.core.Keyword(null,"toon-smooth","toon-smooth",-1986013699),0.08);
...
var gview_22626 = (new Uint32Array(gdata.buffer));
(gview_22626[(24)] = vertex_count);

(gview_22626[(25)] = morph_count);

(gview_22626[(26)] = joint_count);

(gview_22626[(27)] = kind);

(gview_22626[(32)] = shade_kind);
...
var map__22274 = viewport;
var map__22274__$1 = cljs.core.__destructure_map(map__22274);
var device = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"device","device",1817743352));
var queue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"queue","queue",1455835879));
var ctx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"ctx","ctx",-493610118));
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var mesh_context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"mesh-context","mesh-context",832369712));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22274__$1,new cljs.core.Keyword(null,"height","height",1025178622));
