...
return cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21726_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(caps,p1__21726_SHARP_) === true;
...
var runnable = cljs.core.filterv((function (p1__21727_SHARP_){
return kami.gpu.pass_runnable_QMARK_(caps,p1__21727_SHARP_);
}),new cljs.core.Keyword(null,"passes","passes",-2141861841).cljs$core$IFn$_invoke$arity$1(graph));
var skipped = cljs.core.vec((function (){var iter__5480__auto__ = (function kami$gpu$resolve_graph_$_iter__21728(s__21729){
return (new cljs.core.LazySeq(null,(function (){
var s__21729__$1 = s__21729;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21729__$1);
if(temp__5825__auto__){
var s__21729__$2 = temp__5825__auto__;
...
var p = cljs.core._nth(c__5478__auto__,i__21730);
if((!(kami.gpu.pass_runnable_QMARK_(caps,p)))){
cljs.core.chunk_append(b__21731,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"pass","pass",1574159993),(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p);
...
var G__21750 = (i__21730 + (1));
i__21730 = G__21750;
continue;
} else {
var G__21751 = (i__21730 + (1));
i__21730 = G__21751;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21731),kami$gpu$resolve_graph_$_iter__21728(cljs.core.chunk_rest(s__21729__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21731),null);
}
} else {
var p = cljs.core.first(s__21729__$2);
if((!(kami.gpu.pass_runnable_QMARK_(caps,p)))){
...
})(),new cljs.core.Keyword(null,"missing","missing",362507769),kami.gpu.missing_caps(caps,p)], null),kami$gpu$resolve_graph_$_iter__21728(cljs.core.rest(s__21729__$2)));
} else {
var G__21754 = cljs.core.rest(s__21729__$2);
s__21729__$1 = G__21754;
continue;
}
}
} else {
...
/** @this {Function} */
(kami.gpu.requires.cljs$lang$applyTo = (function (seq21744){
var G__21745 = cljs.core.first(seq21744);
var seq21744__$1 = cljs.core.next(seq21744);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21745,seq21744__$1);
}));
