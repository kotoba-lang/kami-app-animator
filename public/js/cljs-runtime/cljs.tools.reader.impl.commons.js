...
var G__21678 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
ch = G__21678;
continue;
} else {
return ch;
...
var vec__21668 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21668,(0),null);
return (match === s);
});
...
var len__5726__auto___21689 = arguments.length;
var i__5727__auto___21690 = (0);
while(true){
if((i__5727__auto___21690 < len__5726__auto___21689)){
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq21674){
