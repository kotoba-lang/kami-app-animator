...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21600 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21600(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21604 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21604(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21617 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21617(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21621 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21621(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21622 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21622(reader);
}
});
